...
1. Jelaskan perbedaan antara asynchronous programming dengan synchronous programming.
   - Dalam pemrograman synchronous, tugas dijalankan secara berurutan. Artinya, kita bisa menyelesaikan tugas pertama sebelum melanjutkan ke tugas berikutnya. Model ini disebut juga sebagai model blocking karena selama satu operasi sedang berjalan, instruksi untuk operasi lainnya diblokir. Penyelesaian tugas pertama memicu tugas berikutnya, dan seterusnya.
   - Dalam pemrograman asynchronous, Kita dapat menjalankan pekerjaan dalam urutan apa pun atau bahkan secara bersamaan. Model ini disebut juga sebagai model non-blocking, yang berarti tidak memblokir eksekusi lebih lanjut sementara satu atau lebih operasi sedang berlangsung. Dengan pemrograman asynchronous, beberapa operasi yang berhubungan dapat berjalan secara bersamaan tanpa harus menunggu tugas lainnya selesai.
2. Dalam penerapan JavaScript dan AJAX, terdapat penerapan paradigma event-driven programming. Jelaskan maksud dari paradigma tersebut dan sebutkan salah satu contoh penerapannya pada tugas ini.
   -Paradigma event-driven programming adalah suatu pendekatan dalam pemrograman yang berfokus pada deteksi dan respons terhadap kejadian atau "event" yang terjadi, seperti aksi pengguna (misalnya klik mouse atau input keyboard) atau perubahan dalam sistem (misalnya menerima data dari server). Dalam paradigma ini, alur program dibangun berdasarkan event yang sedang terjadi di program
3. Jelaskan penerapan asynchronous programming pada AJAX.
   -Asynchronous programming dalam AJAX berarti bahwa AJAX dapat mengirim dan menerima data dari server tanpa harus mereload keseluruhan halaman. Dalam konteks ini, AJAX bekerja dengan cara membuat JavaScript call yang kemudian akan mengaktifkan XMLHttpRequest. Selanjutnya, di background, web browser mengirimkan permintaan (request) HTTP ke server. Server menerima, memproses, dan mengirimkan data kembali ke web browser. Web browser menerima data yang diminta dan akan langsung ditampilkan di halaman tanpa harus melalui proses reload terlebih dulu.
4. Pada PBP kali ini, penerapan AJAX dilakukan dengan menggunakan Fetch API daripada library jQuery. Bandingkanlah kedua teknologi tersebut dan tuliskan pendapat kamu teknologi manakah yang lebih baik untuk digunakan.
   -Fetch API adalah interface bawaan JavaScript yang digunakan untuk melakukan request HTTP. Fetch API menggunakan Promises, yang memungkinkan penanganan respons yang lebih sederhana dan lebih rapi dibandingkan dengan XMLHttpRequest yang digunakan oleh jQuery AJAX. Fetch API tidak perlu library tambahan dan sudah didukung oleh sebagian besar browser modern. Satu hal yang perlu diperhatikan adalah bahwa Fetch API tidak akan menolak Promise bahkan jika mendapatkan status error HTTP seperti 404 atau 500. Fetch API hanya akan menolak Promise jika terjadi kegagalan jaringan atau sesuatu mencegah request untuk diselesaikan.
   -jQuery AJAX adalah bagian dari library jQuery yang menyediakan metode yang mudah untuk melakukan request HTTP. jQuery AJAX memiliki dukungan browser yang lebih luas termasuk Internet Explorer. Namun, jQuery AJAX biasanya memerlukan lebih banyak baris kode dibandingkan dengan Fetch API. Selain itu, jQuery AJAX menggunakan pendekatan callback yang bisa menjadi rumit jika terjadi banyak operasi asynchronous.

   bismillah bisa deploy